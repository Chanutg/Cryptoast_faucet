...
const web3js = new  Web3(Web3.givenProvider || 'https://ropsten.infura.io/4322ccb3e1e747a4ba119af23423cbc1', null, {});
...
contractAddress = "0x7561a3ae2c13c0bfc1ada5fa1500df4ec806a26f";

let makeTransaction = (fromAdresse, toAdresse, amount) => {
    var tokenContract = new web3js.eth.Contract(contractABI, contractAddress);
    var myAddress = '0x9137a74330a30398D6CE47c55980B119414A011b';
    var privateKey = Buffer.from('2cfa1f7a50530520ca186d78372914bda5237a8b71a3e1e4f9df263b57886d41', 'hex')
    var count;
    ...
    return new Promise ((res, rej) => {
        ...
        .then(function(c){
            count = c;
            hexamount = web3js.utils.toHex(amount);
...
router.post("/sendtx", (req, res) => {
    var myAddress = '0xbd85593F294f953dC67dBDd4C34Ff7cd8681156A';
    var privateKey = Buffer.from('2b902faa95a67741c9087464f39e8f66c8676be00a6cb3b653edbd3fff2de537', 'hex')
